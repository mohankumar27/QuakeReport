...
public final class QueryUtils {
    ...
    public static ArrayList<EarthquakeData> fetchEarthquakeData(String query){
        ...
        return extractEarthquakeDatas(jsonResponse);
    }
    ...
    private static URL createUrl(String query) {
        ...
        try{
            ...
            Log.e(LOG_TAG,"query is not proper",e);
        }
        return url;
    }
     ...
     */
    private static ArrayList<EarthquakeData> extractEarthquakeDatas(String earthquakeJSON) {
        ...
        try {
            ...
            // build up a list of EarthquakeData objects with the corresponding data.
            JSONObject earthquakeObject = new JSONObject(earthquakeJSON);
            JSONArray earthquakeList = earthquakeObject.getJSONArray("features");
            for (int i = 0; i < earthquakeList.length(); i++) {
                ...
                EarthquakeData data = new EarthquakeData(magnitude, place, date, url);
